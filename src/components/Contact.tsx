          ...
          <div>
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-8 shadow-md">
              ...
              <div className="flex space-x-4">
                <a href="#" className="p-3 bg-gray-100 dark:bg-gray-700 rounded-full text-gray-700 dark:text-gray-300 hover:bg-blue-500 hover:text-white dark:hover:bg-blue-600 transition-colors">
